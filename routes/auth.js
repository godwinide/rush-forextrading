...
router.post('/signup', async (req, res) => {
    try {
        ...
        if (user || user1) {
            ...
            if (!username || !fullname || !country || !currency || !email || !phone || !password || !password2) {
                return res.render("signup", { ...req.body, error_msg: "Please fill all fields", pageTitle: "Signup", layout: false });
            } else {
                if (password !== password2) {
                    return res.render("signup", { ...req.body, error_msg: "Both passwords are not thesame", pageTitle: "Signup", layout: false });
                }
